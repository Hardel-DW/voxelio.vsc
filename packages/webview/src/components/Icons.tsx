...
export const Octicon = {
    ...
    text_size: (
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16" width="12" height="12">
            ...
            <path d="M13.25 8a.75.75 0 01.75.75v.5h1.5v4.5H15a.75.75 0 000 1.5h2a.75.75 0 000-1.5h-.5v-4.5h1.5v.5a.75.75 0 001.5 0v-1.5a.5.5 0 00-.5-.5h-5a.5.5 0 00-.5.5v1.5a.75.75 0 001.5 0v-.5z" transform="translate(-3, 0) scale(0.7)" />
        </svg>
    )
};
